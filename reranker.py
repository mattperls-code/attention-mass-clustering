...
base_model = AutoModelForSequenceClassification.from_pretrained(base_model_name, num_labels=1, attn_implementation="eager", dtype=torch.float16)
base_model.eval()

ft_model = PeftModel.from_pretrained(
    AutoModelForSequenceClassification.from_pretrained(base_model_name, num_labels=1, attn_implementation="eager", dtype=torch.float16),
    ft_model_name
).merge_and_unload()
ft_model.eval()
